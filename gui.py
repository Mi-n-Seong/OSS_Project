...
class ImageOrganizerGUI:
    def __init__(self, root):
        ...
        self.preview_image = None  # 미리보기 이미지 참조
        ...
        ttk.Checkbutton(opt_frame, text="자동정리", variable=self.opt_auto, command=self.apply_auto).grid(row=0, column=4)
        ...
        self.preview_canvas = tk.Canvas(preview_frame, bg="#2a2b2e", height=280)
    ...
    def _update_log(self, summary, logs):
        ...
        if summary:
            ...
            self.log_box.insert(tk.END, "실행된 작업이 없습니다.\n")
